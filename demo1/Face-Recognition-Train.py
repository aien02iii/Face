...
# This was probably the boring part, right? Don't worry, the fun stuff is coming up next. 
# It's time to train our own face recognizer so that once trained it can recognize new faces of the persons it was trained on. Read? Ok then let's train our face recognizer.
...
#
# I am going to use LBPH face recognizer but you can use any face recognizer of your choice. 
# No matter which of the OpenCV's face recognizer you use the code will remain the same. You just have to change one line, the face recognizer initialization line given below.
